...
class simclr(nn.Module):
  ...
  def loss_cal(self, x, x_aug):
    ...
    weight = torch.exp(-sim_matrix * beta)
    sim_matrix = torch.exp(sim_matrix / T) * weight
...
if __name__ == '__main__':
    ...
    with open('logs_beta_2/log_' + args.DS + '_' + args.aug + '_noise' + str(args.noise_rate), 'a+') as f:
